...
public class MusicPlayerService extends Service implements SensorEventListener {//implements Runnable {
    ...
    private ArrayList<MusicPlayerMgr.MusicMedia> musiclist;//音乐列表
    private MusicPlayerMgr.MusicMedia musicMedia;//当前播放的音乐信息
    ...
    //当前播放音乐
    public MusicPlayerMgr.MusicMedia getMusicMedia() {
        return musicMedia;
    }
    ...
    public void onCreate() {
        ...
        musiclist =  MusicPlayerMgr.musicList;
        // 监听播放是否完成
    ...
    public void onSensorChanged(SensorEvent event) {
        if(MusicPlayerMgr.sharedPreferences.getInt("play_accelerometer",0) == 0){
            // 传感器报告新的值
    ...
    private void playnew() {
        switch (MusicPlayerMgr.sharedPreferences.getInt("play_mode",-1)){
            case 0://随机
        ...
        if(intent != null){
            ...
            if (Build.VERSION.SDK_INT < 16) {
                ...
                PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                        new Intent(this, UnityPlayerActivity.class), 0);
